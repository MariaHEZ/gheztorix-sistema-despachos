...
Contiene scripts SQL y consultas.

## Carpeta docs/

Incluye documentación técnica y diagramas.

## Carpeta capturas/

Almacena evidencias visuales del sistema.
...
## Esquema entidad-relación simplificado
...
# 16. Tablas Principales de la Base de Datos
...
| contraseña | VARCHAR(100) | Contraseña de acceso      |
...
| Campo       | Tipo de dato | Descripción                |
| ----------- | ------------ | -------------------------- |
| id_despacho | INT          | Identificador del despacho |
| fecha       | DATE         | Fecha del despacho         |
| estatus     | VARCHAR(50)  | Estado del despacho        |
| descripcion | VARCHAR(200) | Detalle del servicio       |
...
| id_despacho | INT          | Relación con despacho    |
...
| Campo             | Tipo de dato | Descripción                 |
| ----------------- | ------------ | --------------------------- |
| id_documento      | INT          | Identificador del documento |
| nombre_documento  | VARCHAR(100) | Nombre del archivo          |
| fecha_vencimiento | DATE         | Fecha límite                |
| tipo_documento    | VARCHAR(50)  | Tipo de documento           |
| id_cliente        | INT          | Relación con cliente        |
...
# 19. Flujo Operativo del Sistema
...
# 20. Esquema General del Sistema
